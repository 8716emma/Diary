...
## 최근 변경 사항
- **Microsoft Clarity 통합**: 사용자 경험(UX) 분석을 위해 모든 페이지에 Microsoft Clarity 추적 스크립트를 추가했습니다.
...
- Third-party: Google AdSense, Google Analytics (GA4), Microsoft Clarity, Teachable Machine, Formspree, Disqus
